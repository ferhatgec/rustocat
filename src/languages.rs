...
const WBOLD_RED_COLOR:          &str = "\x1b[1;31m";
const WBOLD_GREEN_COLOR:        &str = "\x1b[1;32m";
const WBOLD_YELLOW_COLOR:       &str = "\x1b[1;33m";
const WBOLD_BLUE_COLOR:         &str = "\x1b[1;34m";
const WBOLD_MAGENTA_COLOR:      &str = "\x1b[1;35m";
const WBOLD_CYAN_COLOR:         &str = "\x1b[1;36m";
const WBOLD_LIGHT_BLACK_COLOR:  &str = "\x1b[1;90m";
const WBOLD_LIGHT_RED_COLOR:    &str = "\x1b[1;91m";

#[allow(dead_code)]
const WBOLD_LIGHT_GREEN_COLOR:  &str = "\x1b[1;92m";
const WBOLD_LIGHT_YELLOW_COLOR: &str = "\x1b[1;93m";
const WBOLD_LIGHT_BLUE_COLOR:   &str = "\x1b[1;94m";
const WBOLD_LIGHT_MAGENTA_COLOR:&str = "\x1b[1;95m";

#[allow(dead_code)]
const WBOLD_LIGHT_CYAN_COLOR:   &str = "\x1b[1;96m";

#[allow(dead_code)]
const WBOLD_LIGHT_WHITE_COLOR:  &str = "\x1b[1;97m";

const WRESET: &str = "\x1b[0m";
